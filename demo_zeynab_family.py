...
"""
This demo file is created to test Person class and BFS searching function
It is linked to the Zeynab_family_tree.json file
"""
...
def build_zeynab_family():
    ...
    # Load from JSON
    loaded_family_dict = load_family_from_json()
...
def search_for_person(first_person, second_person_name):
    """
    BFS searching the relations between two people in a family tree
    take 1 Person object and 1 name as parameter
    """
